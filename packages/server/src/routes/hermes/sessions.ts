...
sessionRoutes.post('/api/hermes/sessions/:id/claude-code-identity', ctrl.setClaudeCodeIdentity)
sessionRoutes.post('/api/hermes/sessions/:id/codex-identity', ctrl.setCodexIdentity)
